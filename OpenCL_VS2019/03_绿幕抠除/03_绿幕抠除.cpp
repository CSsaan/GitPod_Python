...
#define KERNEL_DIR "../resouces/source_03.cl"
#define KERNEL_FUNCTION_NAME "kernel_greenMatting"
...
int main()
{
	...
	Mat grayImage(img_h, img_w, srcImage.type(), Scalar(0, 0, 0));
	...
	//【法二】：直接读取图片缓冲buffer
	ret = clEnqueueReadBuffer(command_queue, mem_objResult, CL_TRUE, 0, BUF4_OutImage_SIZE, grayImage.data, 0, NULL, NULL);
	checkErr(ret, "读取结果");
